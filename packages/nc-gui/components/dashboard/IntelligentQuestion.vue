...
import Icon, { ArrowRightOutlined } from '@ant-design/icons-vue'
      ...
      <div ref="scrollContainer" class="dialog-list">
        ...
        >
          ...
          <div class="action" :style="{ justifyContent: item.isQuestion ? 'flex-end' : 'flex-start' }">
            <NcTooltip v-if="item.isQuestion">
              <template #title>优化问题后进行提问</template>
              <div
                :style="{
              ...
              >
                <icon :style="{ marginRight: '2px', marginTop: '1px' }">
                  <template #component>
                    <svg
                      t="1721720815426"
                      class="icon"
